...
// Usando HeapSort pra ordenar os números de Celular
// Parece que ele tambem consegue ordenar celulares!
...
// Main :)
int main() {
    int arr[] = {988627913, 905766328, 983151882, 997486760, 985545369, 995874132, 991417044, 983842445, 967255037, 993904655};
